...
const items = {
  ...
  content2:
    ...
    "개인적으로 React의 매력에 빠지게 된 계기 중 하나인 컴포넌트의 재사용을 위해 직접 필요한 컴포넌트들을 하나하나 제작해보고, " +
    "깔끔한 반응형 웹 페이지를 만들기 위해 다양한 기기들에서 테스트를 진행하기도 하였으며, " +
    "필요한 애니메이션 효과를 직접 커스터마이징 하는 등 Frontend 에 대해서 조금 더 깊게 이해하게 된 경험이 되었습니다. " +
    "또한 GitHub Pages 를 통해 간단한 정적 웹 페이지 배포를 경험해 볼 수 있었습니다. ",
