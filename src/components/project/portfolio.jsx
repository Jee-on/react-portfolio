...
import pic1 from "../../img/project/portfolio/pic1.png";
import pic2 from "../../img/project/portfolio/pic2.png";
import pic3 from "../../img/project/portfolio/pic3.png";
import pic4 from "../../img/project/portfolio/pic4.png";

const items = {
    title: "포트폴리오 웹사이트 - React",
    date: "2023.08 (1인 프로젝트)",
    content1: "포트폴리오 및 자기소개 용도로 제작한 웹 사이트 입니다./ " + "다른 개발자 분들의 수준급 포트폴리오 웹사이트를 보고 영감을 받아 직접 제작해 보았습니다.",
    content2: "직전 프로젝트에서 쌓은 React 경험을 살려 제작 하였습니다.  " + "개인적으로 React의 매력에 빠지게 된 계기 중 하나인 컴포넌트의 재사용을 위해 직접 필요한 컴포넌트들을 하나하나 제작해보고, " + "깔끔한 반응형 웹 페이지를 만들기 위해 다양한 기기들에서 테스트를 진행하기도 하였으며, " + "필요한 애니메이션 효과를 직접 커스터마이징 하는 등 Frontend 에 대해서 조금 더 깊게 이해하게 된 경험이 되었습니다. " + "또한 GitHub Pages 를 통해 간단한 정적 웹 페이지 배포를 경험해 볼 수 있었습니다. ",
    function: "자기소개, 간단한 인적사항, 기술스택, 프로젝트 소개, 깃허브 및 블로그 링크",
    frontend: "React, Sass, Material-UI",
    backend: "",
    database: "",
    deployment: "GitHub Pages",
    githubUrl: "https://github.com/Jee-on/react-portfolio",
    liveDemoUrl: "",
    siteUrl: "https://jee-on.github.io/react-portfolio/",
    readMeUrl: "",
    pptUrl: "",
};
